"""
Test Settings for API Management Django Application
...
# Database - Use SQLite for testing (faster and no external dependencies)
DATABASES = {
    'default': {
...
# Disable debug toolbar and other development tools during testing
